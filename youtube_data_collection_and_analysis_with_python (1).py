# -*- coding: utf-8 -*-
"""YouTube Data Collection and Analysis with Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1t6GF7jtgdjEnudCttcQNBIbyLfIn94HG
...
# Define API Key & Build YouTube Service
API_KEY = 'AIzaSyB-n_5WAHXDWT6J1QUmC-0sCbYpHAkBXyM' # replace with your own API key
...
def get_trending_videos(api_key, max_results=200):
    ...
    # Handling Pagination (Fetching More than 50 Videos)
...
trending_videos.loc[:, 'description'] = trending_videos['description'].fillna('No description')
...
API_KEY = 'AIzaSyB-n_5WAHXDWT6J1QUmC-0sCbYpHAkBXyM'
youtube = build('youtube', 'v3', developerKey=API_KEY)
